...
class MyriadMarketsConnector(PredictionMarketConnector):
    """Myriad Markets connector (multi-chain)."""
    
    def __init__(self, blockchain_connector, api_url: str = "https://api.myriad.markets"):
        """
        Initialize Myriad Markets connector.
        
        Args:
            blockchain_connector: Blockchain connector instance (Ethereum or Polygon)
            api_url: Myriad Markets API URL
        """
    ...
    def get_markets(
        ...
        try:
            ...
            for item in data.get("markets", []):
                ...
                blockchain = item.get("chain", "ethereum")
