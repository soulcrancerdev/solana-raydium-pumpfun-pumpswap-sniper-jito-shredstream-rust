...
class OLABConnector(PredictionMarketConnector):
    """O.LAB connector."""
    
    def __init__(self, blockchain_connector: BNBChainConnector, api_url: str = "https://api.olab.finance"):
        """
        Initialize O.LAB connector.
        
        Args:
            blockchain_connector: BNB Chain blockchain connector instance
            api_url: O.LAB API URL
        """
